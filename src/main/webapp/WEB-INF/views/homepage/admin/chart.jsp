...
member = await pyfetch(
  url="http://192.168.0.31:8080/withbooks/adminNoChart",
  method="POST",
...
history = await pyfetch(
  url="http://192.168.0.31:8080/withbooks/purchaseHistoryChartList",
  method="GET",
)
...
history = await pyfetch(
  url="http://192.168.0.31:8080/withbooks/purchaseHistoryWChartList",
  method="GET",
)
