		...
		<div class="form">
			...
			<c:if test="${not empty cookie.saveid}">
			  ...
			  <div class="inputWrapper">
				...
				<a href="https://kauth.kakao.com/oauth/authorize?client_id=16bdacdabe4f6f5bbe134b1aca55b22f&redirect_uri=http://192.168.0.31:8080/withbooks/kakaoLogin&response_type=code">
